 ...
 * @Createdate Mon, 22 Jun 2015 15:39:44 GMT
 */
...
if ( ! $nv_Request->isset_request( 'id', 'post,get' ) )
{
	...
	if( ! empty( $q ) )
	{
		$db->where( 'title LIKE :q_title OR catid LIKE :q_catid' );
	}
...
if( $show_view )
{
	...
	while( $view = $sth->fetch() )
	{
		...
		$view['catid'] = $array_catid_event[$view['catid']]['title'];
...
$page_title = $lang_module['event_list'];
